...
public class GroupProject {
    ...
    public static void main(String[] args) {
        ...
        Trainers trainer1 = new Trainers("Rocky", 13, 21);
        Trainers trainer2 = new Trainers("Not Rocky", 8, 16);
        Trainers trainer = new Trainers("billy bob", 6, 14);
        ...
        do {
            ...
            switch (choice) {
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                if (GunsNPoses.checkpTrainerListEmpty()) {
                                    ...
                                    //update membership cost for customer with new personal trainer cost
                                    newCustomer.updateMembershipCost(newPTrainer.getCost());
                ...
                case 5:
                    ...
                    System.out.println("Please add Trainer Start Hour (24 hour clock): ");
                    int trainerStart = sc9.nextInt();
                    System.out.println("Please add Trainer End Hour (24 hour clock): ");
                    int trainerEnd = sc9.nextInt();
                    //creates new trainer from  user input
                    Trainers newTrainer = new Trainers(trainerName, trainerStart, trainerEnd);
                    newClass.setClassStartTime(newTrainer.getClassTime());//sets class start time between trainer start and end hours
...
//                            for (int i =0; i < GunsNPoses.getClasses2().size(); i++){
//                                Classes classNames = GunsNPoses.getClasses2().get(i);
//                                if (classNames.getName().equals(className)){
//                                    GunsNPoses.removeClass(classNames);
